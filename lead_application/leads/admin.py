from leads.models import DealType, Investor, Lead, ListSource, MailingType, PropertyStatus, Status, PointOfContact
...
class LeadAdmin(admin.ModelAdmin):
    ...
    fieldsets = [
        ...
        ('Property information', {'fields': ['folio_id', 'property_street_address', ('property_city', 'property_state', 'property_zip_code'), 'property_status', 'property_bedroom_number', 'property_bathroom_number', 'property_inside_sq_ft', 'property_lot_size', 'property_year_built', 'auction_pending', 'balance_owed', 'auction_date'], 'classes': ['collapse']}),
